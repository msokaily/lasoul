                        ...
                        <div class="form-body form card-body border-top p-9">
                            ...
                            <fieldset class="mt-5">
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <input id="coordinates" required type="text" name="coordinates"
                                            class="form-control" autocomplete="off" title="Please enter coordinates"
                                            placeholder="{{ __('common.coordinates') }}" value="{{ $item->coordinates }}">
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="mt-5">
                                ...
                                <div class="col-lg-6 d-flex align-items-center">
                                    @livewire('upload-file', ['fileId' => old('image', $item->image), 'input' => 'image', 'multiple' => false])
                                </div>
                            </fieldset>

                            <fieldset class="mt-5 row">
                                <div class="col-md" style="position: relative;">
                                    <a href="{{ route('accommodations') }}?location={{ $item->id }}" target="_blank"
                                        class="location-pointer"
                                        style="left: {{ $item->left_shift + 0.8 }}%; top: {{ $item->top_shift }}%">
                                        <div>
                                        ...
                                        <div class="mb-5">
                                            <label class="form-label" for="left_shift">
                                                Left Shift ( on map image ) <span
                                                    class="left_shift_v">{{ $item->left_shift }}</span>%
                                            </label>
                                            <div>
                                                ...
                                                <input type="range" name="left_shift" id="left_shift"
                                        ...
                                        <div class="mb-5">
                                            <label class="form-label" for="top_shift">
                                                Top Shift ( on map image ) <span
                                                    class="top_shift_v">{{ $item->top_shift }}</span>%
                                            </label>
                                            <div>
                                                ...
                                                <input type="range" name="top_shift"
                                                    id="top_shift" max="100" min="0" step="0.5"
                                                    value="{{ $item->top_shift }}">
                                            </div>
                                        </div>
                                        <div class="mb-5">
                                            ...
                                            <div>
                                                <input id="message" type="text" name="message" class="form-control"
                                                    ...
                                                    placeholder="Ex. View Accommodations" value="{{ $item->message }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
