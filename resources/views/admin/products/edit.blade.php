                        ...
                        <div class="form-body form card-body border-top p-9">
                                        ...
                                        <fieldset>
                                            <div class="input-group input-group-solid mb-5">
                                                <input id="name_{{ $key }}" type="text"
                                                    ...
                                                    value="{{ old("name.$key", $item->translate('name', $key)) }}">
                                            </div>
                                        </fieldset>
                                    </div>
                                @endforeach
                                        ...
                                        <fieldset>
                                            <div class="input-group input-group-solid mb-5">
                                                <textarea id="description_{{ $key }}" type="text" name="description[{{ $key }}]" required
                                                    ...
                                                    placeholder="{{ __('common.description') }} ({{ $lang['name'] }})" rows="6">{{ old("description.$key", $item->translate('description', $key)) }}</textarea>
                                            </div>
                                        </fieldset>
                                    </div>
                                @endforeach
                                    ...
                                    <div class="col-md-6">
                                        <select data-control="select2" id="cat_id" name="cat_id"
                                            ...
                                            @foreach ($categories as $one)
                                                <option @if (old('cat_id', $item->cat_id) == $one->id) selected @endif
                            ...
                            <fieldset class="mt-5">
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <div style="width: 300px;">
                                        @livewire('upload-file', ['fileId' => old('image', $item->image) ?? '', 'input' => 'image', 'multiple' => false, 'required' => true, 'fileSize' => 158576])
                                    </div>
                                </div>
                            </fieldset>
                            <!--end::Media-->
                            ...
                            <fieldset class="mt-5">
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    @livewire('upload-file', ['fileId' => old('slider', $item->slider) ?? '', 'input' => 'slider', 'type' => 'media', 'multiple' => true, 'fileSize' => 20971520])
                                </div>
                            </fieldset>
                            <!--end::Media-->
