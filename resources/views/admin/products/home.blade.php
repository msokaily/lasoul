...
@endsection
@section('title') 
    {{ucwords(__('siderbar.'.$page_name))}} {{ $cat ? '( '.$cat->name.' ) Category' : '' }}
@endsection
@if(isAdmin())
    @section('filter') 
        <!--begin::Actions-->
            ...
            <div class="card-header border-0 pt-6 search_div">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end align-items-center">
                        <button type="button" class="btn btn-success submit-sort" @if(!$cat) disabled @endif>{{__("common.save_sort")}}</button>
                    </div>
                    <!--end::Group actions-->
                </div>
                <!--end::Card toolbar-->
