                        ...
                        <div class="form-body form card-body border-top p-9">
                                ...
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-control form-control-solid date-input"
                                            value="{{ old('start_at', $item->start_at) }}" placeholder="Pick date"
                            ...
                            <fieldset class="mt-5">
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-control form-control-solid date-input"
                                            value="{{ old('end_at', $item->end_at) }}" placeholder="Pick date"
                                ...
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <select required data-control="select2" id="limit" name="limit"
                                            ...
                                            <option @if (old('limit', $item->limit) === 'accommodation_must') selected @endif
                                                value="accommodation_must"> Accommodations are Must</option>
                                            <option @if (old('limit', $item->limit) === 'accommodation_optional') selected @endif
                                                value="accommodation_optional"> Accommodations are Optional</option>
                                            <option @if (old('limit', $item->limit) === 'description') selected @endif value="description">
                                                Just a Description</option>
                                        </select>
                                    </div>
                                </div>
                            </fieldset>
                                    ...
                                    <div class="col-md-6">
                                        <select required data-control="select2" id="type_id" name="type_id"
                                            ...
                                            @foreach ($event_types as $one)
                                                <option @if (old('type_id', $item->type_id) === $one->id) selected @endif
                                    ...
                                    <div class="col-md-6">
                                        <select required data-control="select2" id="location_id" name="location_id"
                                            ...
                                            @foreach ($locations as $one)
                                                <option @if (old('location_id', $item->location_id) === $one->id) selected @endif
                                                    value="{{ $one->id }}"> {{ $one->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <fieldset class="mt-5">
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        @livewire('upload-file', ['fileId' => old('image', $item->image), 'input' => 'image', 'multiple' => false, 'fileSize' => 108576, 'required' => true])
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="mt-5">
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-10">
                                        @livewire('upload-file', ['fileId' => old('images', $item->images), 'input' => 'images', 'multiple' => true, 'fileSize' => 108576])
                                    </div>
                                </div>
                            </fieldset>
