        ...
        <div class="portlet-body">
            ...
            <table id="kt_table_accounts" class="table table-row-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <th> {{ucwords(__('common.start_at'))}}</th>
                        <th> {{ucwords(__('common.end_at'))}}</th>
                    ...
                    @forelse($items as $item)
                        <tr class="odd gradeX" id="tr-{{$item->id}}">
                            <td>{{$x++}}</td>
                            <td> <a style="color: black" href="{{ route('admin.' . $page_name . '.edit', [$item->id]) }}">{{$item->title}}</a></td>
                            <td class="center">{{$item->type->title ?? '-'}}</td>
                            <td class="center">{{$item->start_at}}</td>
                            <td class="center">{{$item->end_at}}</td>
                            <td class="center">{{$item->location->title ?? '-'}}</td>
                            <td class="center">
