                        ...
                        <div class="form-body form card-body border-top p-9">
                            ...
                            <fieldset class="mt-5">
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-lg-6 d-flex align-items-center">
                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                            <input @if ($item->is_class == 1) checked @endif
                            ...
                            <div id="classes_div">
                                ...
                                <fieldset class="mt-5">
                                    <div class="input-group input-group-solid mb-5">
                                        ...
                                        <div class="add-remove-rows col-md-10 sortable">
                                            @if(count($item->class_times))
                                                @foreach ($item->class_times as $class_time)
                                ...
                                <fieldset class="mt-5">
                                    <div class="input-group input-group-solid mb-5">
                                        ...
                                        <div class="add-remove-rows col-md-10 sortable">
                                            @if(count($item->class_prices))
                                                @foreach ($item->class_prices as $class_price)
                                                    <div class="col-md-10 col-md-offset-2 mt-5 add-push-row row">
                                                        <div class="col-md-3">
                            ...
                            <div id="durations_div">
                                ...
                                <fieldset class="mt-5">
                                    <div class="input-group input-group-solid mb-5">
                                        ...
                                        <div class="add-remove-rows col-md-10 sortable">
                                            @if(count($item->service_durations))
                                                @foreach ($item->service_durations as $item_duration)
                                                    <div class="col-md-10 col-md-offset-2 mt-5 add-push-row row">
                                                        <div class="col-md-3">
                                                            <label for="duration_id">{{__('common.duration')}}</label>
                                                            <select data-control="select2"
                                                             name="item_durations[duration_id][]" class="form-select form-select-solid item-product">
                                                                <option value="">{{__('common.select')}} </option>
                            ...
                            <fieldset class="mt-5">
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <input min="1" id="max_customers" type="number" name="max_customers" required class="form-control" autocomplete="off" title="Please enter Price" placeholder="{{__('common.max_customers')}}" value="{{ $item->max_customers }}">
                                    </div>
                                </div>
                            </fieldset>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        data-control="select2" data-placeholder="{{__('common.select_option')}}" id="categories" class="form-select form-select-solid">
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{$category->id}}" @if(in_array($category->id, $item->categories->pluck('category_id')->toArray())) selected="selected" @endif>{{$category->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <select options="true" name="employees[]" data-close-on-select="false" multiple
                                            ...
                                            @foreach ($employees as $employee)
                                                @php
                                                    $employeesIds = $item->employees->pluck('employee_id')->toArray();
                                                @endphp
