				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							<!--begin::Form-->
							<form  autocomplete="off" class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="post" action="{{route('admin.login')}}">
								{{csrf_field()}} 
								<!--begin::Heading-->
								<div class="text-center mb-11">
									<!--begin::Title-->
									<h1 class="text-dark fw-bolder mb-3"><a href="/"><img style="width: 200px" class="header-logo" src="{{asset('images/logo.png')}}" alt="{{env('APP_NAME')}}"></a></h1>
									<!--end::Title-->
								</div>
								<!--begin::Heading-->
								<!--begin::Separator-->
