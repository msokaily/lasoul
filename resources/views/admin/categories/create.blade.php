                                    ...
                                    <div class="input-group input-group-solid mb-5">
                                        ...
                                        <div class="col-md-6">
                                            <input id="name_{{ $key }}" type="text"
                                                ...
                                                placeholder="{{ __('common.name') }} ({{$lang['name']}})" value="{{ old("name.$key") }}">
                                        </div>
                                    </div>
                                </fieldset>
                            @endforeach
                                    ...
                                    <div class="col-md-6">
                                        <select data-control="select2" id="parent_id" name="parent_id"
                                            ...
                                            @foreach ($categories as $one)
                                                <option @if (old('parent_id') === $one->id) selected @endif
                            ...
                            <fieldset class="mt-5">
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <div style="width: 300px;">
                                        @livewire('upload-file', ['fileId' => old('image') ?? '', 'input' => 'image', 'multiple' => false, 'required' => false, 'fileSize' => 158576])
                                    </div>
                                </div>
                            </fieldset>
                            <!--end::Media-->
