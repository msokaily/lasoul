        ...
        <div class="col-md-12">
            ...
            <div style="background-color: #f5f8fa; padding-bottom: 30px;" class="card mb-5 mb-xl-10 portlet light bordered">
                ...
                <div id="kt_app_content_container" style="background-color: #f5f8fa" class="app-container container-xxl">
                    <!--begin::Form-->
                    <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework" id="form_category" method="post" action="{{route('admin.'.$page_name.'.store')}}?type={{request('type')}}"
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <!--begin::Select2-->
                                    <select required name="status" data-hide-search="true" required data-control="select2" data-placeholder="{{__('common.select_option')}}" id="status" class="form-select form-select-solid">
                                        <option></option>
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <select required name="location" required data-control="select2" data-placeholder="{{__('common.select_option')}}" id="location" class="form-select form-select-solid">
                                        ...
                                        @foreach ($locations as $location)
                                            <option value="{{$location->id}}" @if($location->id == old('location')) selected="selected" @endif>{{$location->title}}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required class="form-control" value="{{old('space')}}" name="space" type="text">
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required class="form-control" value="{{old('adult_capacity')}}" name="adult_capacity" type="number">
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7  mb-7"></div>
                                    <!--end::Description-->
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required class="form-control" value="{{old('kids_capacity')}}" name="kids_capacity" type="number">
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7  mb-7"></div>
                                    <!--end::Description-->
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required class="form-control" value="{{old('bathroom')}}" name="bathroom" type="number">
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7  mb-7"></div>
                                    <!--end::Description-->
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required class="form-control" value="{{old('beds')}}" name="beds" type="number">
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <!--end::Description-->
                                    <!--end::Input group-->
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0 row">
                                    ...
                                    <div class="col-md-6 d-flex align-items-center">
                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                            <input @if (old('balcony') == 1) checked @endif class="form-check-input w-45px h-30px" type="checkbox" id="balcony" name="balcony">
                                    ...
                                    <div class="col-md-6 d-flex align-items-center">
                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                            <input @if (old('terrace') == 1) checked @endif class="form-check-input w-45px h-30px" type="checkbox" id="terrace" name="terrace">
                                ...
                                <div class="card-body pt-0 row">
                                    ...
                                    <div class="col-md-6 d-flex align-items-center">
                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                            <input @if (old('baby_cot') == 1) checked @endif class="form-check-input w-45px h-30px" type="checkbox" id="baby_cot" name="baby_cot">
                                    ...
                                    <div class="col-md-6 d-flex align-items-center">
                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                            <input @if (old('twin_bed') == 1) checked @endif class="form-check-input w-45px h-30px" type="checkbox" id="twin_bed" name="twin_bed">
                                ...
                                <div class="card-body pt-0 row">
                                    ...
                                    <div class="col-md-12 d-flex align-items-center">
                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                            <input @if (old('ground_floor') == 1) checked @endif class="form-check-input w-45px h-30px" type="checkbox" id="ground_floor" name="ground_floor">
                                ...
                                <div class="card-body pt-0 row">
                                    ...
                                    <div class="col-md-12 d-flex align-items-center">
                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                            <input @if (old('washing_machine') == 1) checked @endif class="form-check-input w-45px h-30px" type="checkbox" id="washing_machine" name="washing_machine">
                                ...
                                <div class="card-body pt-0 row">
                                    ...
                                    data-control="select2" data-placeholder="{{__('common.select_option')}}" id="options" class="form-select form-select-solid">
                                        ...
                                        @foreach ($options as $option)
                                            <option value="{{$option->id}}" @if(is_array(old('options')) AND in_array($tag->id, old('options')))
                                                 selected="selected" @endif>{{$option->title}} - {{$option->price}}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input required type="text" name="title" class="form-control mb-2" placeholder="Product name" value="{{old('title')}}">
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                                    <!--end::Description-->
                                                ...
                                                <!--end::Input group-->
                                                 ...
                                                 <div class="mb-10 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input required type="text" name="number" class="form-control mb-2" placeholder="Product name" value="{{old('number')}}">
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                                    <!--end::Description-->
                                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                                ...
                                                <div>
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Description-->
                                                    <textarea name="description" id="kt_docs_tinymce_hidden">{!!old('description')!!}</textarea>
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input required type="number" step=".01" name="price" class="form-control mb-2" placeholder="Product price" value="{{old('price')}}">
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                                    <!--end::Description-->
                                                    <!--begin::Label-->
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="number" step=".01" name="bundle_price" class="form-control mb-2" placeholder="Product bundle price" value="{{old('bundle_price')}}">
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                                    <!--end::Description-->
                                                    <!--begin::Label-->
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="number" step=".01" name="local_price" class="form-control mb-2" placeholder="Product local price" value="{{old('local_price')}}">
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                                    <!--end::Description-->
                                                </div>
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                data-control="select2" data-placeholder="{{__('common.select_option')}}" id="amenities_tags" class="form-select form-select-solid">
                                                    ...
                                                    @foreach ($amenities_tags as $tag)
                                                        <option value="{{$tag->id}}" @if(is_array(old('amenities_tags')) AND in_array($tag->id, old('amenities_tags'))) selected="selected" @endif>{{$tag->title}}</option>
                                                    @endforeach
                                                </select>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                                ...
                                                data-control="select2" data-placeholder="{{__('common.select_option')}}" id="details_tags" class="form-select form-select-solid">
                                                    ...
                                                    @foreach ($details_tags as $tag)
                                                        <option value="{{$tag->id}}" @if(is_array(old('details_tags')) AND in_array($tag->id, old('details_tags'))) selected="selected" @endif>{{$tag->title}}</option>
                                                    @endforeach
                                                </select>
                                                <!--end::Input-->
                                                <!--begin::Description-->
