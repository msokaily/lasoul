                        ...
                        <div class="form-body form card-body border-top p-9">
                                ...
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select required name="for" data-hide-search="true" data-control="select2" data-placeholder="{{__('common.select_option')}}" id="for" class="form-select form-select-solid">
                                            <option></option>
                                            <option value="options" @if($item->for == "options") selected="selected" @endif>Options</option>
                                            <option value="services" @if($item->for == "services") selected="selected" @endif>Services</option>
                                        </select>
                                        <!--end::Select2-->
                                    </div>
                                </div>
                                ...
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select required name="duration_type" data-hide-search="true" data-control="select2" data-placeholder="{{__('common.select_option')}}" id="duration_type" class="form-select form-select-solid">
                                            <option></option>
                                            <option value="days" @if($item->duration_type == "days") selected="selected" @endif>Days</option>
                                            <option value="minutes" @if($item->duration_type == "minutes") selected="selected" @endif>Minutes</option>
                                        </select>
                                        <!--end::Select2-->
                                    </div>
                                </div>
                            ...
                            <fieldset class="mt-5">
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <input id="value" type="text" name="value" required class="form-control" autocomplete="off" title="Please enter Value" placeholder="{{__('common.value')}}" value="{{ $item->value }}">
                                    </div>
                                </div>
                            </fieldset>
