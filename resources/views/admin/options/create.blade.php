                        ...
                        <div class="form-body form card-body border-top p-9">
                            <fieldset class="mt-5">
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <input id="title" type="text" name="title" required class="form-control" autocomplete="off" title="Please enter Title" placeholder="{{__('common.title')}}" value="{{ old('title') }}">
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-lg-6 d-flex align-items-center">
                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                            <input @if (old('is_durations') == 1) checked @endif
                            ...
                            <fieldset class="mt-5" id="durations_div" @if(old('is_durations') == 1) style="display:none" @endif>
                                <div class="input-group input-group-solid mb-5">
                                    <label class="col-sm-2 form-label">
                                        <span class="symbol">*</span> Durations with prices
                                    </label>
                                    <div class="add-remove-rows col-md-10 sortable">
                                        <div class="col-md-10 col-md-offset-2 mt-5 add-push-row row">
                                            <div class="col-md-3">
                                                ...
                                                <select data-control="select2" required name="item_durations[duration_id][]" class="form-select form-select-solid item-product">
                            ...
                            <div  id="normal_price">
                                ...
                                <fieldset class="mt-5">
                                    <div class="input-group input-group-solid mb-5">
                                        ...
                                        <div class="col-md-6">
                                            <input id="price" step=".01" type="number" name="price" value="{{ old('price') }}" required class="form-control" autocomplete="off" title="Please enter Price" placeholder="{{__('common.price')}}">
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="mt-5">
                                    <div class="input-group input-group-solid mb-5">
                                        ...
                                        <div class="col-md-6">
                                            <input id="bundle_price" step=".01" type="number" value="{{ old('bundle_price') }}" name="bundle_price" required class="form-control" autocomplete="off" title="Please enter Price" placeholder="{{__('common.bundle_price')}}">
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="mt-5">
                                    <div class="input-group input-group-solid mb-5">
                                        ...
                                        <div class="col-md-6">
                                            <input id="local_price" step=".01" value="{{ old('number') }}" type="number" name="local_price" required class="form-control" autocomplete="off" title="Please enter Price" placeholder="{{__('common.local_price')}}">
                                        </div>
                                    </div>
                                </fieldset>
                            ...
                            <fieldset class="mt-5">
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-lg-6 d-flex align-items-center">
                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                            <input @if (old('is_quantity') == 1) checked @endif
                            ...
                            <fieldset id="quantity_div" class="mt-5" style="display: @if (old('is_quantity') == 1) block; @else none; @endif ">
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <input id="quantity" type="number" value="{{ old('quantity') }}" name="quantity" class="form-control" autocomplete="off" title="Please enter Quantity" placeholder="{{__('common.quantity')}}">
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="mt-5">
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        @livewire('upload-file', ['fileId' => old('image') ?? '', 'input' => 'image', 'multiple' => false, 'fileSize' => 108576])  
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="mt-5">
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <textarea required class="form-control" rows="10" name="description">{{ old('description') }}</textarea> 
                                    </div>
                                </div>
                            </fieldset>
