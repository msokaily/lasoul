            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        <!--begin::Form-->
                        <form  autocomplete="off" class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="post" action="{{ url(app()->getLocale().'/password/email') }}">
                            {{csrf_field()}} 
                            <!--begin::Heading-->
                            ...
                            <!--begin::{{__('common.submit')}} button-->
								<div class="d-grid mb-10">
									<button type="submit" id="kt_sign_in_submit" class="btn btn-primary">
										...
										<span class="indicator-label">{{__('website.send_reset_link')}}</span>
										<!--end::Indicator label-->
