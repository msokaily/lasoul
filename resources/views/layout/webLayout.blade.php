...
<body data-rsssl="1"
    ...
    <div id="perspective">
        ...
        <div class="mobile-menu-wrapper">
            <div class="mobile-menu-content">
                <div class="menu-main-menu-container">
                    <div class="container">
                        <select class="lang-switch form-control">
                            @foreach ($available_locales as $langCode => $lang)
                                <option value="{{$langCode}}" @selected($current_locale == $langCode)>{{$lang['name']}}</option>
                            @endforeach
                        </select>
                    </div>
                    @php
                    ...
                    <ul id="mobile_main_menu" class="mobile-main-nav">
                        ...
                        <li class="menu-item">
                            <a href="{{ route($menu_item_name) }}">{{ content_get($div_name . 'link_' . $menu_item_name, $menu_item_name . ' (' . $current_locale . ')', __('common.' . $menu_item_name)) }}</a>
                        </li>
                        @php $menu_item_name = 'about'; @endphp
                        <li class="menu-item">
                            <a href="#{{ $menu_item_name }}">{{ content_get($div_name . 'link_' . $menu_item_name, $menu_item_name . ' (' . $current_locale . ')', __('common.' . $menu_item_name)) }}</a>
                        </li>
                            ...
                            <section
                                ...
                                <div class="elementor-container elementor-column-gap-default">
                                    <div class="elementor-row">
                                        <div class="elementor-column elementor-col-40 elementor-top-column elementor-element elementor-element-eb2db78 elementor-hidden-tablet elementor-hidden-phone"
                                        ...
                                        <div style="width: 10%;" class="elementor-column elementor-col-10 elementor-top-column elementor-element elementor-element-b401b7a elementor-hidden-phone"
                                                            ...
                                                            <div class="elementor-button-wrapper">
                                                                <a href="tel:{{$settings->mobile}}"
                                                                    ...
                                                                    <span class="elementor-button-content-wrapper">
                                                                        <span
                                                                            class="elementor-button-text my-mobile-txt" dir="ltr">{{$settings->mobile}}</span>
                                                                    </span>
                                                                </a>
                                                            </div>
                                                        </div>
                                        ...
                                        <div style="width: 13%;" class="elementor-column elementor-col-10 elementor-top-column elementor-element elementor-element-fcec661"
                                            data-id="fcec661" data-element_type="column"
                                            data-settings='{"craftcoffee_ext_is_scrollme":"false","craftcoffee_ext_is_smoove":"false","craftcoffee_ext_is_parallax_mouse":"false","craftcoffee_ext_is_infinite":"false","craftcoffee_ext_is_fadeout_animation":"false"}'>
                                            <div class="elementor-column-wrap elementor-element-populated">
                                                <div class="elementor-widget-wrap">
        ...
        <script>
            $('.lang-switch').change(function(e) {
                const url = "{{\Request::getRequestUri()}}";
                window.location.href = url.replace("{{$current_locale}}", e.target.value);
            });
            setTimeout(() => {
